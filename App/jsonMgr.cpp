...
#pragma region iPath
template<>
cPath<Interface>::~cPath() {}

iObj*& cPath<Interface>::Path() {
	return this->obj;
}

eType cPath<Interface>::Type() {
	return Interface;
}

#pragma endregion
#pragma region cPath_Obj
eType cPath<Obj>::Type() {
	return Obj;
}
#pragma endregion
#pragma region cPath_Str
eType cPath<Str>::Type() {
	return Str;
}
#pragma endregion
#pragma region cPath_Dic
eType cPath<Dic>::Type() {
	return Dic;
}

iObj*& cPath<Dic>::Path() {
	if (!this->obj) return this->Self();

	switch (this->obj->Type()) {
	case Dic: {
		return this->obj->Union().classDictionary->dic[this->key];
	}
	default: {
		return this->Self();
	}
...
cPath<Dic>::cPath(iObj* a, std::string _key) : cPath<Interface>(a), key(_key) {}

#pragma endregion
#pragma region cPath_List
eType cPath<List>::Type() {
	return List;
}

iObj*& cPath<List>::Path() {
	if (!this->obj) return this->Self();

	switch (this->obj->Type()) {
	case List: {
		return this->obj->Union().classList->vector[this->idx];
	} 
	default: {
		return this->Self();
	}
...
#pragma region PathMgr
cPathMgr& cPathMgr::operator[](std::string a) {
	this->obj = cPath<Dic>(this->obj, a).Path();
	return *this;
}

cPathMgr& cPathMgr::operator[](size_t a) {
	this->obj = cPath<List>(this->obj, a).Path();
	return *this;
}
#pragma endregion
